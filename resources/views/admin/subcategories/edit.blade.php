...
@section('content_header')
    <h1>Editar Subcategoría <strong>{{ $subcategory->name }}</strong></h1>
@stop
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ old('name', $subcategory->name) }}" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="status" class="form-control @error('status') is-invalid @enderror"
                                        name="status">
                                        <option value="{{ true }}" {{ $subcategory->status ? 'selected' : '' }}>Activo</option>
                                        <option value="{{ 0 }}" {{ !$subcategory->status ? 'selected' : '' }}>Inactivo</option>
